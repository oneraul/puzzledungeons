...
class SkinningColorShader implements Shader {
    ...
    public void init() {
        ...
        u_bones = program.fetchUniformLocation("u_bones", true); // ShaderProgram#getUniformLocation fails, maybe because it's an array?
    ...
    public boolean canRender(Renderable renderable) {
        return renderable.bones != null
            ...
            && renderable.material.has(ColorAttribute.Diffuse)
