...
public class Floor extends CacheableTile implements Pool.Poolable {
    ...
    Floor() {
        if(model != null) {
            ...
            //modelInstance.transform.setToRotation(Vector3.Y, 90*MathUtils.random(3));
        }
    }

    Tile init(int x, int y) {
